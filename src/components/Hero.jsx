...
export default function Hero () {
  ...
  return (
    <>
    <section className='mx-auto flex min-h-[80vh] w-11/12  flex-col-reverse items-center justify-center gap-8 pb-12 sm:px-6 lg:min-h-[90vh] lg:grid lg:grid-cols-2 lg:gap-12 lg:px-8 lg:pb-0 overflow-hidden'>
      {/* Text Section */}
      <div className='flex flex-col justify-center text-center lg:text-left'>
